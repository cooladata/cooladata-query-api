public class QueryAPI
    {
        ...
        public static string COOLADATA_ACCEPT_HTML_HEADER = "text/html";
        public static string COOLADATA_ACCEPT_JSON_HEADER = "application/json";
        private static string COOLADATA_CHARSET = "UTF-8";
        private static string COOLADATA_ENDPOINT = "https://app.cooladata.com/api/v1/projects/" + COOLADATA_PROJECTID + "/cql/";
